      ...
      <div class="motto">
        ...
        <ModuleTransition delay="0.04">
          <h1
            ...
            class="longcang">
            {{ motto.zh || $frontmatter.heroText || $title || "码农老杨" }}
          </h1>
        </ModuleTransition>
        ...
        <a
          href="#anchor"
          class="scroll-down bounce-enter-active down-arrow"></a>
      </div>
      <component
        v-if="bubbles"
        :is="bubbles"
        :options="options"
        style="pointer-events: none"></component>
    </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      motto() {
        return (
          this.$themeConfig.mottos[Math.floor(Math.random() * 7)] || {
